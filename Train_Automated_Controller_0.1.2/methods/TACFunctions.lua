...
function TACEntity:reinitTrainData()
	self.globalData.trainId=nil
	self.globalData.trainState=nil
end
...
function TACEntity:processRules()
	...
	if not train or train.id==self.globalData.trainId or train.state==self.globalData.trainState then
		return
	end
	self.globalData.trainId=train.id
	self.globalData.trainState=train.state
	--process rules
