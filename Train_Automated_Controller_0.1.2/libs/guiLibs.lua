...
function InitOpeningGui(data,openedEntity)
...
function OnAdd(guiElement)
	if get_or_set_guiElementData(guiElement.parent).luaGuiObject.onAdd then
		get_or_set_guiElementData(guiElement.parent).luaGuiObject.onAdd(guiElement.parent)
	end
...
function OnRemove(guiElement)
	if get_or_set_guiElementData(guiElement.parent).luaGuiObject.onRemove then
		get_or_set_guiElementData(guiElement.parent).luaGuiObject.onRemove(guiElement.parent)
	end
