...
(
  ...
  {
    { variation = 0, main_offset = util.by_pixel(0.2, 10), shadow_offset = util.by_pixel(0.2, 10), show_shadow = true },
    { variation = 1, main_offset = util.by_pixel(-0.1, 10.2), shadow_offset = util.by_pixel(-0.1, 10.2), show_shadow = true },
...
local trainStopRec=createData("rail-signal","rail-signal",trainStopReceiver,
{
