...
local function initLocomotiveGui()
	...
	newSignal:add{type="slider",name="count",onAction=ChangeValue,minimum_value=1,maximum_value=5000,value=1}
	newSignal:add{type="textfield",name="textSignalCount",onAction=ChangeValue,regexp="%d*",onLoad=updateCount, noSaveInData=true}
